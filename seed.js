  ...
  const seedUserProfiles = [
      { user_id: seedUsers[0]._id,
       ...
       { user_id: seedUsers[2]._id,
        ...
        loveLanguague:"words of affirmation",
        imageUrl:'https://lacks-aa-dev.s3.us-west-1.amazonaws.com/profile+picture.png',
        happinessLevel:80,
        location:"Los Angeles",
        commitmentLevel:85,
